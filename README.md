# Title: Fucking Testing Assignments
...
1. **Fucking** `Postman`
2. **Fucking** `Apache JMeter`
3. **Fucking** `Oracle Java`
4. **Fucking** `Apache Maven`
5. **Fucking** `JUnit5`
6. **Fucking** `Python`
7. **Fucking** `Pytest`
8. **Fucking** `Selenium`
...
- [x] January 27, 2026/Interface Testing/`Postman`/[report](./January_27.md)
